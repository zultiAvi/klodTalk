...
summary: "Classify a Claude run's stop_reason/stop_details: stop_reason=='refusal' with a null category is the signature of a hallucinated / workspace-auth false-positive refusal (re-assert the auth preamble); a cyber/bio category is a genuine policy refusal to surface verbatim."
---
...
- `category in {"cyber","bio"}` -> genuine policy refusal; surface `explanation` verbatim.
...
## Source
- Claude Platform API release notes (2026-06-02 / 2026-05-28) —
