...
- `claude-sonnet-4-20250514` — **retiring TOMORROW — June 15, 2026 (RETIRED after)**; use `sonnet` alias instead
- `claude-opus-4-20250514` — **retiring TOMORROW — June 15, 2026 (RETIRED after)**; use `opus` alias instead
